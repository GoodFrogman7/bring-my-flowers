...
const DASHBOARD_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <rect width="128" height="128" rx="28" fill="#fdf2f8"/>
  <circle cx="64" cy="64" r="34" fill="#b83280"/>
  <circle cx="64" cy="64" r="14" fill="#fde68a"/>
  <ellipse cx="64" cy="38" rx="12" ry="18" fill="#f472b6"/>
  <ellipse cx="86" cy="58" rx="12" ry="18" fill="#f472b6" transform="rotate(72 64 64)"/>
  <ellipse cx="76" cy="84" rx="12" ry="18" fill="#f472b6" transform="rotate(144 64 64)"/>
  <ellipse cx="52" cy="84" rx="12" ry="18" fill="#f472b6" transform="rotate(216 64 64)"/>
  <ellipse cx="42" cy="58" rx="12" ry="18" fill="#f472b6" transform="rotate(288 64 64)"/>
</svg>`;
...
export function startDashboard(options: DashboardOptions): http.Server {
  ...
  const buildHealth = () => {
    ...
    return {
      ...
      ownerSheetDm: (process.env.OWNER_SHEET_DM || '0').trim() === '1'
    };
  };
